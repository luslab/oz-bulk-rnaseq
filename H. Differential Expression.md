...
2. DESeq2 looks at average normalised reads across all samples. If average is above CPM threshold then it keeps the gene.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDQ4NjI1ODksMTMyMzQzNTYyLDE5Nj
