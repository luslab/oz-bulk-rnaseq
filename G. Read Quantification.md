...
sbatch -N 1 -c 4 --mem=24GB --wrap="java -jar $EBROOTQORTS/QoRTs.jar mergeCounts --mergeFiles **LIST QC FILES** --generatePlots --singleEnded $SAMPLE $GTF ${OUT}_${SRRID}"
done
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2ODYzOTU0NCwxNTkzMzMwODE2LDIwMj
