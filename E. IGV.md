...
```bash
#set bam input
BAM=/home/camp/ziffo/working/oliver/projects/airals/alignment/D0_samples/*_Aligned.sortedByCoord.out.bam
#set OUT
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwNzk3NTczMywyMTE5MTA0NTUsMTgwOT
