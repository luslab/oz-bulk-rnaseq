...
Deal with opposite strand issue with strand-specific library prep. To deal with same strand isoforms calculate the maximum likelihood estimation to det
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1OTA3MjQwNiwxNTc2MzQ2NTQ2LC01Nz
