...
```
sbatch -N 1 -c 8 --mem=40GB --wrap="vast-tools align /home/camp/ziffo/working/oliver/projects/airals/reads/D0_samples/SRR5483802_1.fastq -sp Hsa"
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjAxODIyMTcsODAxNjU2NDU3LC0xMT
